<h2><a href="https://practice.geeksforgeeks.org/problems/two-repeated-elements-1587115621/1?page=2&difficulty[]=-1&difficulty[]=0&status[]=unsolved&sortBy=submissions">Two Repeated Elements</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">You are given an array of <strong>N+2</strong> integer elements. All elements of the array are in the range 1 to N. Also,&nbsp;all elements occur once except two numbers which occur twice. Find the two repeating numbers.<br>
<br>
