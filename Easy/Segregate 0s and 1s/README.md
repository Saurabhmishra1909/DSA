<h2><a href="https://practice.geeksforgeeks.org/problems/segregate-0s-and-1s5106/1?page=2&difficulty[]=-1&difficulty[]=0&status[]=unsolved&sortBy=submissions">Segregate 0s and 1s</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array&nbsp;of length N consisting of&nbsp;only 0s and 1s in random order. Modify the array to segregate 0s on left side and 1s on the right side of the array. </span></p>
